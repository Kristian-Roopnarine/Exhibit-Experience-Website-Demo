""" 
This file contains the functions that remap the ticket types into a grade range to display on the website and save for future use.
"""
...
def order_grade_range(group_list,grade_order):
    ...
    print(sorted_grade_range)
    print(sorted_special_range)
